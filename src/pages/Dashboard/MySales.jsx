...
import useGetBookingsBySellerEmailWithPagination from '../../hooks/queries/bookings/useGetBookingsBySellerEmailWithPagination';
import LoadingSpinner from '../../components/LoadingSpinner';
import Pagination from '../../components/Pagination';
import MySalesTableRow from '../../components/dashboard/MySales/MySalesTableRow';
...
const MySales = () => {
    ...
    const { data, isLoading, isError, error } = useGetBookingsBySellerEmailWithPagination(user?.email, page)
                                ...
                                <tbody>
                                    {sortedBookings.length > 0 ? (
                                        sortedBookings.map((booking) => (
                                            <MySalesTableRow key={booking._id} booking={booking} />
                                        ))
                                    ) : (
                                        <tr>
