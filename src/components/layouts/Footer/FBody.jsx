            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div className='lg:justify-items-center'>
                    ...
                    <ul className="gap-5 list-disc marker:text-primary ml-5 space-y-2">
                        <li><NavLink to="/" className={({ isActive }) => isActive ? "text-primary" : 'text-secondary'}>Home</NavLink></li>
                        <li><NavLink to="/available-cars" className={({ isActive }) => isActive ? "text-primary" : 'text-secondary'}>Available Cars</NavLink></li>
                        {user &&
                            <>
                                <li><NavLink to="/add-car" className={({ isActive }) => isActive ? "text-primary" : 'text-secondary'}>Add Car</NavLink></li>
                                <li><NavLink to="/my-cars" className={({ isActive }) => isActive ? "text-primary" : 'text-secondary'}>My Cars</NavLink></li>
                            </>
                        }
                        <li>
                            {user &&
                                <NavLink to="/my-bookings" className={({ isActive }) => isActive ? "text-primary" : 'text-secondary'}>My Bookings</NavLink>
                            }
                        </li>
                    </ul>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <p className='text-sm text-gray-500'>Want to be notified about our services. Just sign up and we'll send you a notification by email.</p>
